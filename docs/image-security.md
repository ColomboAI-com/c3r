...
retain build-time Python packaging dependencies. The image runs as UID/GID
10001 and is smoke-imported in CI before scanning. The HIGH/CRITICAL scan
continues to fail the image job until a subsequent result shows zero findings.
